...
**4. 🔍 [Modularity Detection on Zachary Karate Club (C)](https://github.com/melih-tugrul-erdogdu/Community-Detection-Algorithms-C)**
* Modularity detection algorithm for social network analysis.
* Implemented in C.
* Calculates and outputs the optimal community structures.

**5. 🌱 [Automatic Plant Watering System](https://github.com/melih-tugrul-erdogdu/Arduino-Automatic-Plant-Watering-System)**
...
**6. 🐍 [Snake Game (C)](https://github.com/melih-tugrul-erdogdu/Snake-Game-C)**
